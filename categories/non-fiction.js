 ...
 const newBooks =[
    {
      ...
      "description": "Explores the history of humankind from the Stone Age to the modern era, examining how culture and society evolved.",
    ...
    },
    {
      ...
      "title": "Atomic Habits",
      "author": "James Clear",
      "description": "A practical guide to building good habits, breaking bad ones, and mastering the small behaviors that lead to big results.",
    ...
    },
    {
      ...
      "description": "A memoir about a woman who grows up in a survivalist family with no formal education and eventually earns a PhD from Cambridge University.",
